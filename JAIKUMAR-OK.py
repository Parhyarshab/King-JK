...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> 03312734753")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://pastebin.com/raw/2ceqHj0i').text
			if basesplit in plr:
				key = basesplit
...
▒█░▒█ ▒█░▒█ ▒█░░▀█ ▒█▄▄█ ▒█░▒█ ▒█░▒█
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : JAIKUMAR-KING          │
    │ [✓] GITHUB   : DONT__WAST__TIME😁            │
    │ [✓] WHATSAPP :  03312734753      │
    ...
    └───────────────────────────────────────┘  """)
		...
		print("\033[97;1m   ───────────────────────────────────────")
		print("\033[92;1m         JAIKUMAR KING JR   x   Pro JAIKUMAR    ")
		print("\033[97;1m   ───────────────────────────────────────")
